...
bool CRKLog::Write(string text)
{
	...
	snprintf(szDateTime, 100, "%04d-%02d-%02d.txt", timeNow.tm_year + 1900, timeNow.tm_mon + 1, timeNow.tm_mday);
	...
	try {
		...
		snprintf(szDateTime, 100, "%02d:%02d:%02d \t", timeNow.tm_hour, timeNow.tm_min, timeNow.tm_sec);
